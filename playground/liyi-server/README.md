...
| 02 | [「解析度鎖死了」——其實是有人一直在偷改](實戰筆記/02-遠端桌面解析度與HiDPI.md) | 遠端桌面解析度、高 DPI，以及寫死在圖檔裡的標題列高度 | `infra-2-1` |
| 03 | [一台機器上的三套 DNS](實戰筆記/03-三套DNS與自架區網解析.md) | systemd-resolved vs dnsmasq，以及一個會製造間歇性故障的設定陷阱 | `infra-3-1`、`infra-3-4` |
