...
1. **事故指揮官（Incident Commander, IC）**：整場事故的總指揮，統籌全局、做關鍵決策、協調各角色——但不自己動手修。
2. **操作負責人（Ops Lead）**：實際動手的人，專心診斷、執行止血與修復，不用分心去應付外界詢問。
3. **溝通負責人（Comms Lead）**：對外定期更新狀態給主管、客服、使用者，同時擋掉外界干擾，讓操作的人能專心。

（大事故中最好還有第四個「記錄」的角色，專門記時間軸，作為之後 postmortem 的命脈；人手不夠時至少由 IC 確保有人在記。）
...
**類比**：消防現場的總指揮，不會自己抓起水管衝進火場。他要站在外面，綜觀整棟樓的火勢、調度所有消防員、決定戰術。一旦他衝進去，就沒人在綜觀全局、沒人指揮了。IC 的價值就在於**抽離、綜觀、決策、協調**，而不是衝第一線。

**如果 IC 陷進技術細節會發生什麼**：一個人專注修某個細節時，視野會收窄到那個細節上，看不到整體狀況、其他線索、也判斷不出「該不該換方向」。偏偏 IC 通常是最資深、最該綜觀全局的人——他一陷進去，整場事故就群龍無首、各自為政：沒人做關鍵決策、沒人協調角色、沒人擋外界干擾，效率反而更差，甚至把事情搞得更糟。所以動手的事要交給操作負責人，IC 專心指揮。
...
判斷基準是：**影響範圍大不大、我一個人搞不搞得定。** 兩者只要一個成立、又在惡化，就該升級。

1. **邊緣小功能壞、少數人受影響、你正在查** → **不用升級**。這是典型小事故，影響有限、你一個人 on-call 就能全包（自己當 IC + 操作）。除非後續發現影響擴大或卡住了。
2. **整個網站掛了、使用者大量抱怨、你一個人理不清** → **該升級**。影響全站又超出一個人能力，正是啟動完整指揮系統的時機：宣告重大事故、拉人進來、分開角色。
3. **修了 20 分鐘沒進展、影響還在擴大** → **該升級**。兩個危險訊號都出現了——處理不來、而且在惡化。這時要及早承認「我需要幫忙」、宣告重大事故並找人分擔角色。**及早求援是專業，不是失敗。**
