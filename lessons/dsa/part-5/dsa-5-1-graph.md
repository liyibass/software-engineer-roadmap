...
**1.**
這題是開放題，重點是分清「誰是頂點、誰是邊」。示範一組答案：假設我有三個朋友——阿明、小華、婷婷，而且我和三個人都是朋友，阿明和小華彼此也認識，婷婷則只認識我。

- **頂點（vertex）**：我、阿明、小華、婷婷（四個「人」）。
- **邊（edge）**：我—阿明、我—小華、我—婷婷、阿明—小華（四條「朋友關係」）。
...
因為「朋友」是雙向關係（你是我朋友，我也是你朋友），所以邊沒有箭頭——這是一張**無向圖**。

**2.**
判斷關鍵：這個關係「換個方向講還成不成立」？成立 → 無向；不成立 → 有向。

- **Facebook 好友**：無向。加好友要雙方同意，「A 是 B 的好友」必然「B 也是 A 的好友」，是對稱的雙向關係。
- **Instagram 追蹤**：有向。「A 追蹤 B」不代表「B 追蹤 A」，方向不對稱，要用箭頭。
- **城市間道路**：一般是無向（大多數道路能雙向通行）。但如果要精確表達「單行道」，那條邊就得畫成有向。
- **網頁連結**：有向。網頁 A 放了連到 B 的超連結，不代表 B 也連回 A，方向是單向的。

**3.**
「樹是特殊的圖」是因為樹在「圖」的基礎上多加了兩個限制：

1. **無環（acyclic）**：樹裡從任一點出發，不可能沿著邊繞一圈回到自己；一般的圖可以有環（例如小明—小美—大華—小明）。
2. **連通（connected）**：樹一定是連在一起的一整塊，任兩個頂點之間都走得到；一般的圖可以分成好幾塊互不相連。

這兩個限制合起來，會推出樹的一個招牌性質：**任兩點之間「恰好只有一條路徑」**（不多不少）。也因此，一棵有 n 個頂點的樹，剛好有 n − 1 條邊——比一般的圖「更精簡、更有秩序」。所以樹是圖的一個「子集合」：所有樹都是圖，但不是所有圖都是樹。
